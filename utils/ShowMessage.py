...
import sys  # 处理路径
from tkinter import Tk, Label # 处理 GUI 界面
from threading import Thread # 处理多线程
from time import sleep  # 处理延时
import pyautogui  # 处理鼠标键盘操作
from random import randint  # 处理随机数
